    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Az OmniClima 360™ készüléked előkészítés alatt áll és hamarosan kiszállítjuk.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#9a3412', fontWeight: 600, marginBottom: '0.25rem' }}>RENDELÉSSZÁM</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', fontWeight: 700, color: '#1E293B', marginBottom: '1rem' }}>📦 Következő lépések:</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Rendelés előkészítése</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Szállítás</div>
              <div style={{ color: '#64748b', fontSize: '0.8rem' }}>24 órán belül</div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Kézbesítés</div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Utánvétes fizetés</div>
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Készítsd elő a pontos összeget (49 990 Ft) a futár számára</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Kérdésed van? Írj nekünk: <a href="mailto:info@ketronica.com" style={{ color: '#ea580c', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
