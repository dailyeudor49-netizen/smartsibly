    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Vaš NovaClean X1 PRO + OMNI Station se pripravlja a čoskoro bude odoslaný.
        </p>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.8rem' }}>V priebehu 24 hodín</div>
            </div>
          </div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Platba pri prevzatí</div>
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Pripravite točen znesek (79,00 €) za kurirja</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Imate vprašanja? Pišite nam: <a href="mailto:info@ketronica.com" style={{ color: '#10b981', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
