    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Twój OmniClima 360™ jest przygotowywany i wkrótce zostanie wysłany.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#9a3412', fontWeight: 600, marginBottom: '0.25rem' }}>NUMER ZAMÓWIENIA</div>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Przygotuj dokładną kwotę (299 zł) dla kuriera</div>
          </div>
        </div>
