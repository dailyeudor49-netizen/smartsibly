    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Az Air Wave Smart™ klímaberendezésed előkészítés alatt áll és hamarosan kiszállítjuk.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#166534', fontWeight: 600, marginBottom: '0.25rem' }}>RENDELÉSSZÁM</div>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Készítsd elő a pontos összeget a futár számára</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Kérdésed van? Írj nekünk: <a href="mailto:info@ketronica.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
