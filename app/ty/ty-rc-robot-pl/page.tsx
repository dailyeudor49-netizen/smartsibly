    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Az Ön NovaClean X1 PRO + OMNI Station készül és hamarosan kiszállítjuk.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#047857', fontWeight: 600, marginBottom: '0.25rem' }}>RENDELÉSI SZÁM</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', fontWeight: 700, color: '#1E293B', marginBottom: '1rem' }}>📦 Następne kroki:</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Feladás</div>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Készítse elő a pontos összeget (29 990 Ft) a futárnak</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Kérdése van? Írjon nekünk: <a href="mailto:info@ketronica.com" style={{ color: '#10b981', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
