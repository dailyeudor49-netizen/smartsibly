    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Twój system bezpieczeństwa BeSecure Pro™ jest przygotowywany i wkrótce zostanie wysłany.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#1e40af', fontWeight: 600, marginBottom: '0.25rem' }}>NUMER ZAMÓWIENIA</div>
        ...
        <div style={{
          ...
          Pytania? Skontaktuj się z nami: <a href="mailto:info@ketronica.com" style={{ color: '#2563eb', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
