...
const CountdownTimer = () => (
  <div className="bg-orange-600 text-white text-xs md:text-sm font-bold py-2 text-center flex justify-center items-center gap-2 sticky top-0 z-50 shadow-lg">
    ...
    <span>2025-ÖS BEVEZETŐ AJÁNLAT: Az ár emelkedik <span className="inline-block w-12 text-center bg-black/20 rounded ml-1 font-mono">04:12</span> múlva</span>
  </div>
);
  ...
  <nav className="sticky top-[32px] z-40 bg-white/95 backdrop-blur-md border-b border-zinc-200 px-4 py-3 w-full shadow-sm">
    <div className="max-w-7xl mx-auto flex justify-between items-center">
      ...
      <button onClick={scrollToForm} className="bg-zinc-950 hover:bg-orange-600 text-white px-5 py-2.5 rounded-full flex items-center gap-2 transition-all shadow-lg hover:shadow-orange-500/30 transform hover:-translate-y-0.5 text-sm font-bold">
        ...
        <span className="hidden md:inline">RENDELÉS MOST</span>
        <span className="md:hidden">RENDELÉS</span>
      </button>
    </div>
  </nav>
);
...
export default function OmniClimaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      router.push('/ty/ty-fb-climate-hu');
    } catch (error) {
    ...
    <div className="min-h-screen bg-zinc-50 font-sans selection:bg-orange-500 selection:text-white w-full overflow-x-hidden">
      ...
      <div className="relative bg-zinc-100 pb-12 md:pb-20 overflow-hidden">
        ...
        <div className="w-full bg-black py-2 overflow-hidden border-b border-zinc-800 relative z-10">
           <div className="flex animate-marquee whitespace-nowrap gap-12 text-xs font-bold text-white uppercase tracking-widest items-center">
              <span className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-green-500"/> 24 Hónapos Kasko Garancia</span>
              <span className="flex items-center gap-2"><Trophy className="w-4 h-4 text-yellow-500"/> 2025 Legjobb Tech Innováció</span>
              <span className="flex items-center gap-2"><Truck className="w-4 h-4 text-orange-500"/> Ingyenes Szállítás Budapestről</span>
              <span className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-green-500"/> 24 Hónapos Kasko Garancia</span>
              <span className="flex items-center gap-2"><Trophy className="w-4 h-4 text-yellow-500"/> 2025 Legjobb Tech Innováció</span>
           </div>
        </div>
          ...
          <div className="grid md:grid-cols-12 gap-8 items-start">
            ...
            <div className="md:col-span-7 relative">
                <div className="w-full h-[300px] md:h-[500px] rounded-2xl shadow-2xl bg-white overflow-hidden relative">
                  <Image
                    ...
                    alt="OmniClima 360 - Űrtechnológiai Design"
                    fill
                ...
                <div className="mt-4 flex items-center justify-between bg-white border border-zinc-200 p-3 rounded-xl shadow-sm">
                   <div className="flex items-center gap-3">
                      ...
                      <div>
                         <p className="font-bold text-zinc-900 text-sm"><span className="text-green-600 font-black">{viewers} Felhasználó</span> aktív</p>
                         <p className="text-zinc-500 text-xs">Most fontolgatják a vásárlást</p>
                      </div>
                   </div>
                   <div className="bg-red-50 text-red-600 text-xs font-black px-3 py-1 rounded-full border border-red-100 flex items-center gap-1">
                      <Flame className="w-3 h-3 fill-current" /> UTOLSÓ DARABOK
                   </div>
                </div>
            </div>
            ...
            <div className="md:col-span-5 flex flex-col relative z-10">
                ...
                <h1 className="text-4xl md:text-6xl font-display font-black text-zinc-900 mb-4 tracking-tight leading-[0.95]">
                  Végleges Stop a <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-red-600">Magas Számláknak.</span>
                </h1>

                <p className="text-lg text-zinc-600 font-medium mb-8 leading-relaxed">
                   Az első <strong className="text-black bg-zinc-200 px-1 rounded">AI-vezérelt All-in-One</strong> klímatorony, amely 15 perc alatt ideális hőmérsékletre hozza a szobádat, miközben csak annyit fogyaszt, mint egy izzó.
                </p>
                ...
                <div className="space-y-3 mb-8">
                   <div className="flex items-start gap-4 p-3 rounded-xl hover:bg-white transition-colors border border-transparent hover:border-zinc-200">
                      ...
                      <div>
                         ...
                         <p className="text-sm text-zinc-600">Turbina technológia, amely megszünteti a hideg zónákat. Egyenletes meleg mindenhol.</p>
                      </div>
                   </div>
                   ...
                   <div className="flex items-start gap-4 p-3 rounded-xl hover:bg-white transition-colors border border-transparent hover:border-zinc-200">
                      ...
                      <div>
                         <h4 className="font-bold text-zinc-900">EcoSmart™ Processzor</h4>
                         <p className="text-sm text-zinc-600">Milliszekundumonként szabályozza a teljesítményt. Akár 60%-os megtakarítás a fogyasztáson.</p>
                      </div>
                   </div>
                   ...
                   <div className="flex items-start gap-4 p-3 rounded-xl hover:bg-white transition-colors border border-transparent hover:border-zinc-200">
                      ...
                      <div>
                         <h4 className="font-bold text-zinc-900">Aktív HEPA Tisztítás</h4>
                         <p className="text-sm text-zinc-600">Eltávolítja a port, allergéneket és kellemetlen szagokat fűtés közben.</p>
                      </div>
                   </div>
                </div>
                ...
                <div className="bg-white rounded-3xl border border-zinc-200 shadow-xl overflow-hidden relative">
                  <div className="p-6 border-b border-zinc-100">
                    ...
                    <p className="text-center text-xs text-zinc-400 mt-3 font-medium flex justify-center items-center gap-1">
                       <Lock className="w-3 h-3" /> Nincs előre fizetés. Utánvéttel fizetsz.
                    </p>
                  </div>
                </div>
            </div>
      ...
      <div className="bg-zinc-950 text-white relative">
        ...
        <section className="py-20 px-4 max-w-7xl mx-auto border-b border-white/5">
           <ScrollReveal className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                 ...
                 <h2 className="text-4xl md:text-5xl font-display font-bold mb-6">Hagyd abba a hely és pénz pazarlását.</h2>
                 <p className="text-zinc-400 text-lg mb-6 leading-relaxed">
                    Fűtőtest, ventilátor, légtisztító, párátlanító. 4 drága és terjedelmes gépre lenne szükséged.
                    <strong className="text-white block mt-2">Az OmniClima 360 a végleges monolit megoldás.</strong>
                 </p>
                 <ul className="space-y-4">
                    <li className="flex items-center gap-4 bg-white/5 p-4 rounded-lg border border-white/5">
                      ...
                      <div>
                        <strong className="block text-white">PTC Kerámia Fűtés</strong>
                        <span className="text-sm text-zinc-500">Tél: Azonnali meleg 3 másodperc alatt.</span>
                      </div>
                    </li>
                    <li className="flex items-center gap-4 bg-white/5 p-4 rounded-lg border border-white/5">
                      <Wind className="text-blue-500 w-6 h-6" />
                      <div>
                        <strong className="block text-white">Vortex Ventilláció</strong>
                        <span className="text-sm text-zinc-500">Nyár: Erős és csendes friss szellő.</span>
                      </div>
                    </li>
                 </ul>
              </div>
              <div className="w-full h-[400px] rounded-2xl bg-zinc-900/50 border border-orange-500/30 overflow-hidden relative">
                  <Image
                    ...
                    alt="Összehasonlítás: 4 Készülék vs 1 OmniClima"
                    fill
                    className="object-contain"
                  />
                </div>
        ...
        <section className="py-20 px-4 max-w-7xl mx-auto border-b border-white/5">
           <ScrollReveal delay={200} className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-1 md:order-2">
                 ...
                 <h2 className="text-4xl md:text-5xl font-display font-bold mb-6">Intelligens Teljesítmény.</h2>
                 <p className="text-zinc-400 text-lg mb-8">
                    A hagyományos fűtőtestekkel ellentétben, amelyek "elégetik" a levegőt, az OmniClima <strong className="text-blue-400">Űrtechnológiai PTC Kerámia</strong> lapokat használ.
                    A meleg lágy, körülölelő és nem szárítja ki a torkot.
                 </p>
                 <div className="grid grid-cols-2 gap-4">
                    <div className="bg-blue-900/20 border border-blue-500/20 p-5 rounded-xl text-center">
                       <h3 className="text-3xl font-bold text-white mb-1">3mp</h3>
                       <p className="text-xs text-blue-300 uppercase font-bold">Azonnali Fűtés</p>
                    </div>
                    <div className="bg-blue-900/20 border border-blue-500/20 p-5 rounded-xl text-center">
                       <h3 className="text-3xl font-bold text-white mb-1">25dB</h3>
                       <p className="text-xs text-blue-300 uppercase font-bold">Ultra Csendes</p>
                    </div>
                 </div>
              </div>
           </ScrollReveal>
        ...
        <section className="py-20 px-4 max-w-7xl mx-auto">
           <ScrollReveal delay={200} className="text-center mb-16 max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-5xl font-display font-bold mb-6">Tiszta levegő, <span className="text-green-500">egészséges tüdő.</span></h2>
              <p className="text-zinc-400 text-lg">
                 A téli otthonok ötször szennyezettebbek, mint a szabadban. A beépített HEPA szűrő csendben dolgozik, hogy megvédje családodat.
              </p>
           </ScrollReveal>
           ...
           <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
              <div className="bg-zinc-900 border border-white/10 p-8 rounded-3xl relative overflow-hidden group hover:border-green-500/50 transition-all">
                 ...
                 <h3 className="text-xl font-bold mb-2">Allergia-ellenes</h3>
                 <p className="text-zinc-400 text-sm">A pollen, por és atka 99,9%-át megfogja. Ideális allergiásoknak.</p>
              </div>
              <div className="bg-zinc-900 border border-white/10 p-8 rounded-3xl relative overflow-hidden group hover:border-purple-500/50 transition-all">
                 ...
                 <h3 className="text-xl font-bold mb-2">Stop Konyhai Szagok</h3>
                 <p className="text-zinc-400 text-sm">Az aktív szenes szűrő percek alatt semlegesíti a sütés és füst szagát.</p>
              </div>
              <div className="bg-zinc-900 border border-white/10 p-8 rounded-3xl relative overflow-hidden group hover:border-blue-500/50 transition-all">
                 ...
                 <h3 className="text-xl font-bold mb-2">Párátlanít</h3>
                 <p className="text-zinc-400 text-sm">Megelőzi a penész és az ablakokon lecsapódó pára kialakulását fűtés közben.</p>
              </div>
           </div>
        </section>
      </div>
      ...
      <section className="py-16 px-4 bg-black border-y border-white/10">
         <div className="max-w-6xl mx-auto">
            <h3 className="text-2xl font-bold text-white mb-8 text-center">Mit mondanak ügyfeleink</h3>
            <div className="grid md:grid-cols-3 gap-6">
               <ReviewCard name="Kovács Péter" role="Ellenőrzött Vásárlás" text="Szkeptikus voltam az 'all-in-one' megoldással, de 10 perc alatt felmelegíti a 30 nm-es nappalim. Nagyon csendes." />
               <ReviewCard name="Nagy Éva" role="Ellenőrzött Vásárlás" text="A gázszámla rémisztett. Ezzel csak este használom, ahol kell. Tiszta megtakarítás." />
               <ReviewCard name="Dr. Szabó" role="Üzleti Ügyfél" text="3 darabot vettem a rendelőmbe. Tiszta levegő és tökéletes hőmérséklet a pácienseknek. Nagyon elegáns design." />
            </div>
         </div>
      </section>
      ...
      <section className="py-16 px-4 bg-zinc-900">
         ...
         <h3 className="text-3xl font-bold text-white mb-8 text-center">Gyakran Ismételt Kérdések</h3>
         <div className="space-y-2">
            <AccordionItem question="Mennyit fogyaszt valójában?" answer="Az EcoSmart chip jóvoltából, miután elérte a hőmérsékletet (kb. 15 perc), a fogyasztás drasztikusan csökken egy egyszerű izzó fogyasztására a fenntartáshoz." />
            <AccordionItem question="Zajos éjszaka?" answer="Egyáltalán nem. A 'Night' mód 25dB alá csökkenti a zajszintet és kikapcsolja a LED kijelzőt, hogy ne zavarja az álmot." />
            <AccordionItem question="Hogyan működik az utánvétes fizetés?" answer="Egyszerű. Most rendelsz az űrlap kitöltésével. Nem fizetsz semmit online. Amikor a futár megérkezik (24/48 órán belül), készpénzben fizeted a pontos összeget." />
            <AccordionItem question="Kell telepítés?" answer="Nem, az OmniClima használatra készen érkezik. Kiveszed a dobozból, bedugod a konnektorba és azonnal működik." />
         </div>
         </div>
      </section>
          ...
          <div className="glass-panel p-6 md:p-10 rounded-3xl shadow-2xl">
             ...
             {submitted ? (
               <div className="text-center py-10">
                  ...
                  <h3 className="text-3xl font-bold text-white mb-4">Rendelés Fogadva!</h3>
                  <p className="text-zinc-300 mb-8">Köszönjük. Operátorunk hamarosan felhív a szállítás megerősítéséhez.</p>
                  <button onClick={() => window.location.reload()} className="text-orange-500 underline">Vissza a főoldalra</button>
               </div>
             ) : (
               <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10 mb-6">
                     ...
                     <div className="text-xs text-zinc-500 flex flex-col gap-1">
                        ...
                        <span className="flex items-center gap-1"><Gift className="w-3 h-3 text-purple-500"/> Extra HEPA Szűrő Ajándékba</span>
                     </div>
                  </div>

                  <div className="space-y-4">
                    <div>
                        <label className="text-xs font-bold text-zinc-500 uppercase ml-1">Teljes Név</label>
                        <input name="fullName" required placeholder="Pl: Kovács János" onChange={handleInputChange} className="w-full bg-black/40 border border-zinc-700 rounded-xl px-4 py-4 text-white placeholder-zinc-600 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all" />
                    </div>

                    <div>
                       <label className="text-xs font-bold text-zinc-500 uppercase ml-1">Cím és Város</label>
                       <textarea name="fullAddress" required rows={2} placeholder="Pl: Kossuth utca 10, Budapest" onChange={handleInputChange} className="w-full bg-black/40 border border-zinc-700 rounded-xl px-4 py-4 text-white placeholder-zinc-600 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all resize-none" />
                    </div>

                    <div>
                       <label className="text-xs font-bold text-zinc-500 uppercase ml-1">Mobilszám</label>
                       <input name="phone" type="tel" required placeholder="Pl: +36 30 123 4567" onChange={handleInputChange} className="w-full bg-black/40 border border-zinc-700 rounded-xl px-4 py-4 text-white placeholder-zinc-600 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all" />
                       <p className="text-[10px] text-zinc-500 mt-1 ml-1">*Fontos a futár számára</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-yellow-500/10 border border-yellow-500/20 p-4 rounded-xl flex gap-3 items-center">
                     ...
                     <p className="text-sm text-zinc-300 leading-tight">Biztonságos fizetés <strong>utánvéttel készpénzben</strong>. Nincs szükség bankkártyára.</p>
                  </div>
