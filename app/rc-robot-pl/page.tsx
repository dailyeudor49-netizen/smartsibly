...
export default function RobotAspirapolvereProLanding() {
  ...
  const comparisonData = [
    ...
    { feature: "Celková cena", robot: "349 zł SE STANICÍ", without: "12 000+ zł za stejné funkce" },
  ];
  ...
  const reviews = [
    { nome: 'Tomáš K.', paese: 'Polska', flag: '🇵🇱', testo: 'Tři velcí psi. Vysával jsem KAŽDÝ DEN. S tímto robotem vysávám jednou za TÝDEN jen rohy. 90 % práce dělá on. Nejlepší nákup za posledních 5 let.', stelle: 5, data: 'před 5 dny', risposta: 'Tomáši, děkujeme! Majitelé zvířat jsou naši nejspokojenější zákazníci.' },
    { nome: 'Petra N.', paese: 'Polska', flag: '🇵🇱', testo: 'Manžel byl skeptický. "Za tuhle cenu to bude hračka". Po 2 týdnech se mi omluvil. Čistí LÉPE než náš starý Roomba za 15 000 zł. Stanice, která sama vyprazdňuje, je geniální.', stelle: 5, data: 'před týdnem' },
    { nome: 'Martin S.', paese: 'Polska', flag: '🇵🇱', testo: 'Byt 85m² na dvou patrech. Nosím ho nahoru a dolů a všechno udělá sám. Nekonečná baterie, nikdy jsem ho nemusel přerušit uprostřed. Tichý, pouštím ho když pracuji z domu.', stelle: 5, data: 'před 3 dny', risposta: 'Martine, přesně! Baterie 5200mAh vydrží až 6 hodin!' },
    { nome: 'Hana L.', paese: 'Polska', flag: '🇵🇱', testo: 'Je mi 68 let a mám problémy se zády. Nemůžu už vysávat. Tento robot mi změnil život. Naprogramuji ho a on udělá všechno. Konečně si můžu užívat čistý byt bez bolesti.', stelle: 5, data: 'před 4 dny' },
    { nome: 'Jakub V.', paese: 'Polska', flag: '🇵🇱', testo: 'Alergik na roztoče celý život. Od té doby, co používám tohoto robota s HEPA filtrem, vstávám bez ucpaného nosu. Rozdíl je OBROVSKÝ. Měl jsem ho koupit už dávno.', stelle: 5, data: 'před 2 týdny', risposta: 'Jakube, HEPA H13 filtr opravdu dělá rozdíl pro alergiky!' },
    { nome: 'Lenka W.', paese: 'Polska', flag: '🇵🇱', testo: 'Porovnala jsem ho s Roborockem za 22 000 zł od švagra. STEJNÉ FUNKCE. On tomu nevěřil. Ukázala jsem mu stanici, která vyprazdňuje a myje. Teď chce taky jeden.', stelle: 5, data: 'před týdnem' },
    { nome: 'Eva M.', paese: 'Polska', flag: '🇵🇱', testo: 'Dům se 3 kočkami. Chlupy byly noční můra. Teď robot projede 2x denně a dům je vždy perfektní. Návštěvy nevěří, že mám 3 kočky. NEJLEPŠÍ DÁREK, co jsem si kdy dala.', stelle: 5, data: 'před 6 dny' },
    { nome: 'Ondřej H.', paese: 'Polska', flag: '🇵🇱', testo: 'Dlouhá zima, dům stále zavřený. Prach se hromadil rychle. Teď robot čistí každý den, když jsem v práci. Vracím se domů a dýchám čistý vzduch. Stojí za každou korunu.', stelle: 5, data: 'před 10 dny', risposta: 'Ondřeji, přesně! Perfektní pro dlouhé zimy.' },
    { nome: 'Markéta T.', paese: 'Polska', flag: '🇵🇱', testo: 'Dlouhé vlasy všude, to byla moje noční můra. Tento robot je VŠECHNY vysaje, aniž by se zasekl. Kartáč se nikdy nezablokuje. Zkoušela jsem 3 roboty předtím, konečně jeden, co funguje!', stelle: 5, data: 'před 8 dny' },
    { nome: 'David B.', paese: 'Polska', flag: '🇵🇱', testo: 'Používám ho 2 měsíce, každý den. Žádné problémy. Kvalita je stejná jako u robotů za 25 000 zł. Ušetřil jsem spoustu peněz a mám stále čistý byt. Doporučuji všem.', stelle: 5, data: 'před 12 dny', risposta: 'Davide, děkujeme za důvěru! Kvalita mluví sama za sebe.' },
  ];
    ...
    <div className="min-h-screen bg-white overflow-x-hidden font-sans leading-relaxed">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t-2 border-blue-600 shadow-2xl">
        <div className="max-w-md mx-auto px-4 py-2">
          <div className="flex items-center justify-between mb-1">
            <span className="text-red-600 font-bold text-sm animate-pulse">Pozostało tylko {stockLeft}!</span>
            <span className="text-green-700 font-black text-xl">349 zł</span>
          </div>
          <button
          ...
          >
            <span>OBJEDNAT — PŁATNOŚĆ PRZY ODBIORZE</span>
          </button>
        </div>
      </div>
      ...
      <div className="bg-red-600 text-white py-2 text-center font-bold text-sm px-4">
        <div className="flex items-center justify-center gap-2">
          ...
          <span>BŁYSKAWICZNA OFERTA — Kończy się za: {formatTime(timeLeft)}</span>
        </div>
      </div>
      ...
      <section className="bg-gradient-to-b from-gray-900 to-gray-800 pt-6 pb-4 md:py-8 px-4 text-white">
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-red-500 text-white text-sm md:text-base font-bold py-2 px-4 rounded-full inline-block mb-4 animate-pulse">
            TOTALNA WYPRZEDAŻ — OSTATNICH {stockLeft} SZTUK
          </div>
          <h1 className="text-2xl md:text-4xl font-black mb-4 leading-tight tracking-tight">
            ODKURZA, MOPUJE I OPRÓŻNIA SIĘ<br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">JEDNYM PRZEJŚCIEM</span>
          </h1>
          <p className="text-lg md:text-xl mb-4 text-gray-300">
            Wyrzuć mopa, wiadro i miotłę. <span className="font-bold text-white">On wszystko zrobi sam.</span>
          </p>
          <div className="bg-white/10 backdrop-blur border border-white/20 rounded-xl p-4 inline-block">
            <span className="line-through text-gray-400 text-xl">440 zł</span>
            <span className="text-4xl md:text-5xl font-black text-white ml-3">349 zł</span>
            <span className="block text-green-400 font-bold mt-1">Automatyczna stacja GRATIS (wartość 1499 zł)</span>
          </div>
        </div>
      </section>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-5 mb-6 shadow-xl relative overflow-hidden">
              ...
              <div className="bg-gray-50 rounded-xl p-4 mb-4 border border-gray-100">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-gray-400 line-through text-xl">440 zł</span>
                  <span className="bg-green-100 text-green-700 text-xs font-bold px-2 py-1 rounded">UŠETŘÍTE 91 zł</span>
                </div>
                <div className="text-center">
                  <span className="text-5xl font-black text-green-700">349 zł</span>
                </div>
              </div>
              ...
              >
                OBJEDNAT — PŁATNOŚĆ PRZY ODBIORZE
              </button>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-10">
            <div className="inline-block bg-blue-600 text-white text-sm font-bold px-4 py-1 rounded-full mb-4">
              ZDARMA V CENĚ (HODNOTA 14 990 zł)
            </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-lg text-gray-600 text-center mb-8">
            Stejné funkce, o 10 000 zł méně. Počítejte sami.
          </p>
      ...
      <section className="bg-red-600 py-6">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-white text-xl font-black mb-3">
            Totální výprodej — Pozostało tylko {stockLeft} kusů
          </p>
          <p className="text-white/80 mb-4">Až se vyprodají, cena se vrátí na 440 zł. Stanice zdarma pouze pro tyto poslední kusy.</p>
          <button
            onClick={openOrderPopup}
          ...
          <div className="bg-white rounded-2xl p-6 shadow-2xl">
            ...
            <div className="bg-gray-50 rounded-xl p-4 mb-4 border border-gray-200">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  <span className="text-gray-400 line-through text-sm block">440 zł</span>
                  <span className="text-3xl font-black text-green-700">349 zł</span>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              >
                {isSubmitting ? 'ODESÍLÁNÍ...' : 'OBJEDNAT — PŁATNOŚĆ PRZY ODBIORZE'}
